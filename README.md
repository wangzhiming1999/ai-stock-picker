...
- **实战形态**：多周期共振 / 揉搓线 / 断头铡刀 / 地量见地价 / 天量见天价 / 分时顶背离 / MACD 零轴金叉 / MA10 三日失守，以及单峰密集 / 低位低获利盘 / 筹码转移向上 十一条可复核技巧，逐条条件展示（全部成立才命中）
- **形态回测验证**：walk-forward 检验十一条技巧的历史表现，方向化胜率 + 同区间基准对比 + 命中去重，样本不足不给结论

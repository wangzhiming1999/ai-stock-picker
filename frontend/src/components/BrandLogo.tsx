...
const SIZE_MAP = {
  sm: { box: "h-8 w-8", icon: "h-4 w-4", text: "text-sm", sub: "text-[10px]", glow: "shadow-[0_0_8px_rgba(37,99,235,0.35)]" },
  md: { box: "h-10 w-10", icon: "h-5 w-5", text: "text-base", sub: "text-[11px]", glow: "shadow-[0_0_14px_rgba(37,99,235,0.45)]" },
